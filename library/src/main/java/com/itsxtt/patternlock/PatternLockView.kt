...
class PatternLockView : GridLayout {
    ...
    companion object {
        ...
        const val DEFAULT_CELL_SIZE = 0f // unit: dp
    ...
    private var cellSizeDp: Float = 0f // units: dp
    ...
    constructor(context: Context, attributeSet: AttributeSet) : super(context, attributeSet) {
        ...
        cellSizeDp = ta.getDimension(R.styleable.PatternLockView_troya_cellSize, DEFAULT_CELL_SIZE)
    ...
    private fun setupCells() {
        for(i in 0..(plvRowCount-1)) {
            for(j in 0..(plvColumnCount-1)) {
                val cell = Cell(context, i * plvColumnCount + j,
                        ...
                        lineStyle, regularLineColor, errorLineColor, plvColumnCount, indicatorSizeRatio, cellSizeDp)
